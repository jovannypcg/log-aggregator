...
/**
 * Comparator of {@link LogFileHolder} instances by the log their hold.
 *
 ...
 * to convert them into Instants or other kind of date objects for comparison, as
 * this format provides lexicographical order, which means that they can be
